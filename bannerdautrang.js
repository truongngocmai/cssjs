...
$(window).load(function() {
		if(document.cookie.indexOf("adf") == -1)
		{
			...
			$("#myModal").html("<a href='http://phulonggroup.com.vn/' target='_blank'><img src='http://phulonggroup.com.vn:7787/mediaroot/media/userfiles/useruploads/861/image/bds/du-an-Sai-gon-south-plaza.jpg/' width='500px'/><br/>13 Kỹ thuật đẩy top vượt trội</a>. Học tại nhà CEO Faceseo. <h2><a class='close-linhnguyen-modal'>X</a></h2>");
